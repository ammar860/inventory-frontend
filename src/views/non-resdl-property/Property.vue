...
import CreatePropertyModal from "@/components/non-resdl-property/CreatePropertyModal.vue";
import EditPropertyModal from "@/components/non-resdl-property/EditPropertyModal.vue";
import MaintainanceShowModal from "@/components/non-resdl-maintenance/MaintenanceShowModal.vue";
...
export default {
    ...
    methods: {
        ...mapActions({
            getNonResidendialProperties: "appData/getNonResidendialProperties",
